...
function MediaGalleryHeader(props: MediaGallerySectionProps) {
    ...
    return (
        <div>
            {props.supertitle && (
                <p className={classNames('supertitle', 'uppercase', 'text-xs', 'text-center', 'text-neutral', 'mb-2')} data-sb-field-path=".supertitle">
                    {props.supertitle}
                </p>
            )}
            {props.title && (
                <h1 className={classNames('text-3xl', 'sm:text-4xl', 'md:text-5xl', 'lg:text-6xl', styles.title ? mapStyles(styles.title) : null)} data-sb-field-path=".title">
